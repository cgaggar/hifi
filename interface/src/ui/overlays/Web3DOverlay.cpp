...
void Web3DOverlay::loadSourceURL() {
    ...
    if (sourceUrl.scheme() == "http" || sourceUrl.scheme() == "https" ||
        ...
        if (_webSurface->getRootItem() && _webSurface->getRootItem()->objectName() == "tabletRoot") {
            ...
            _webSurface->getRootContext()->setContextProperty("SoundCache", DependencyManager::get<SoundCache>().data());
            _webSurface->getRootContext()->setContextProperty("MenuInterface", MenuScriptingInterface::getInstance());
